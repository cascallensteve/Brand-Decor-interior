...
const MainHeader = () => {
  ...
  return (
    <div className="bg-white shadow-sm border-b border-gray-200 px-4 py-4 relative">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          ...
          />
          <div>
            <h1 className="text-lg sm:text-xl font-bold text-gray-900">Brand Decor</h1>
        ...
        <nav className="hidden lg:flex items-center space-x-6 xl:space-x-8">
          <Link to="/" className="relative text-gray-900 hover:text-orange-500 transition-all duration-300 font-medium group overflow-hidden">
          ...
          <Link to="/shop" className="relative text-gray-900 hover:text-orange-500 transition-all duration-300 font-medium group overflow-hidden">
            <span className="relative z-10 transform transition-transform duration-300 group-hover:-translate-y-1">
              Shop
            </span>
            <span className="absolute top-0 left-0 transform translate-y-full transition-transform duration-300 group-hover:translate-y-0 text-orange-500">
