...
const Footer = () => {
  return (
    <footer className="bg-white">
      {/* Benefits Section */}
      <div className="py-12 lg:py-16 px-4 sm:px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            
            {/* Award-Winning Design */}
            <div className="flex items-start space-x-4">
              <div className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-sm flex-shrink-0 text-2xl">
                🏆
              </div>
              <div>
                <h3 className="font-bold text-gray-800 text-lg mb-1">Award-Winning Design</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 text-lg mb-1">Sustainable Materials</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="font-bold text-gray-800 text-lg mb-1">Expert Craftsmanship</h3>
      ...
      {/* Main Footer */}
      <div className="py-12 lg:py-16 px-4 sm:px-6 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                ...
                />
                <div>
                  <h2 className="text-xl font-bold text-gray-800">Brand Decor</h2>
                  <p className="text-sm text-gray-600">Furniture</p>
                </div>
              </div>
              <div className="mb-6">
                <h3 className="font-semibold text-gray-800 mb-3">About Brand Decor Furniture</h3>
                <h4 className="text-lg font-medium text-gray-700 mb-3">Creating Beautiful Spaces Since 2015</h4>
            ...
            {/* Contact & Address */}
            <div>
              <h3 className="font-bold text-gray-800 text-lg mb-6">Contact</h3>
              <div className="space-y-4">
                <div>
                  <p className="text-gray-600">(+254) 0714139461</p>
                  <p className="text-gray-600">sales@branddecorinteriors.co.ke</p>
                </div>
                <div>
      ...
      {/* Bottom Footer */}
      <div className="py-4 sm:py-6 px-4 sm:px-6 bg-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-4 sm:gap-0">
          ...
          <div className="flex items-center space-x-4">
            <button className="w-8 h-8 bg-gray-100 hover:bg-orange-500 rounded-full flex items-center justify-center group transition-all duration-300">
